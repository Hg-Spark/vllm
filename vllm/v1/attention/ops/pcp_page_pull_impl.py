...
"""Optimized page-aware one-sided KV pull for PCP runahead."""
...
from vllm.v1.attention.ops.pcp_nixl_prepared import PCPNixlPreparedTransport
...
class PCPPagePullTransport:
    ...
    def __init__(
        ...
        *,
        ...
        self._peer = PCPNixlPreparedTransport(
    ...
    def _physical_page_geometry(kv_cache: torch.Tensor) -> tuple[int, int]:
        return PCPNixlPreparedTransport.physical_page_geometry(kv_cache)
