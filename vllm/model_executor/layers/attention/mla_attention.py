    ...
    *,
    ...
    for source_row, kv_start, kv_length, token_slice, continuation in jobs:
        ...
        native = build_mla_chunked_context_metadata(
            context_lens_cpu=_flat_int32([kv_length]),
            prefill_query_start_loc_cpu=_flat_int32([0, query_len]),
    ...
    return (
        _flat_int32(merged_starts).to(builder.device, non_blocking=True),
        _flat_int32(merged_query_lens),
